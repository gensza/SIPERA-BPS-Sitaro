      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item active">
            <a href="riwayat-pengguna.php" class="nav-link active">
     ...
     <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
              ...
              <h3 class="card-title">[ RIWAYAT ] PENGGUNA</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <thead>
                  ...
                  <?php
            							...
            							$query=mysqli_query($konek,"SELECT * FROM `history` WHERE `user`='$pengguna' AND `flag`='0' ORDER BY `id` ASC");
            							$no = 1;
