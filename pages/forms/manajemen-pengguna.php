    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="manajemen-pengguna.php" class="nav-link active">
     ...
     <div class="container-fluid">
        <div class="row">
          ...
          <div class="card">
              ...
              <div class="card-body">
              <a class="btn btn-app bg-secondary float-right" data-target="#AddUsers" data-toggle="modal">
              <?php $query = mysqli_query($konek, "SELECT COUNT(*) AS JUMLAH FROM `i_us3r` WHERE `flag`<'3'");
                                                    if($query == false){
                                                        ...
                                                        ?>  
                <span class="badge bg-success"><?php echo $user["JUMLAH"]; ?></span>
                                                        <?php
                                                        }
                                                        ?>
              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  <?php
            			 				include "../config_sqli.php";
            							$query=mysqli_query($konek,"SELECT * FROM `i_us3r` WHERE `flag`<'3' ORDER BY `id` ASC");
            							$no = 1;
                  ...
                  <tr>
                    ...
                    <td align='center'><a href="#profil<?php echo $row['id']; ?>" data-toggle="modal" title="click to see"> <span class="fa fa-eye"></span> </a></td>
                    ...
                    <?php include "button-profil.php"; ?>
                    <?php include "button-edit-user.php"; ?>
                    <?php include "button-delete-user.php"; ?>
  ...
  <div id="AddUsers" class="modal fade" tabindex="-1" role="dialog">
        ...
        <button type="button" class="close" data-dismiss="modal">&times;</button>
					...
					<div class="modal-body">
						<form action="pengguna-add.php" name="modal_popup" enctype="multipart/form-data" method="POST">
							<div class="form-group">
								<label>Nama Lengkap</label>
									<div class="input-group">
										<input name="nama_lgkp" required type="text" class="form-control"/>
									</div>
							</div>
              <div class="form-group">
              ...
              <div class="form-group">
								<label>NIP</label>
									<div class="input-group">
										<input name="nip" required type="text" class="form-control"/>
									</div>
							</div>
              <div class="form-group">
								<label>Jabatan</label>
									<div class="input-group">
                  <select style="cursor:pointer" tabindex="1" name="jabatan" class="form-control">
													<option disabled selected="selected" value="0">== PILIHAN ==</option>
                          <option value="Kepala Sub Bagian Umum">1 - KASUBAG UMUM</option>
													<option value="Statistisi Ahli Muda">2 - STATISTISI AHLI MUDA</option>
													<option value="Pranata Komputer Ahli Muda">3 - PRANATA KOMPUTER AHLI MUDA</option>
                          <option value="Statistisi Ahli Pertama">4 - STATISTISI AHLI PERTAMA</option>
                          <option value="Pranata Komputer Ahli Pertama">5 - PRANATA KOMPUTER AHLI PERTAMA</option>
                          <option value="Statistisi Terampil">6 - STATISTISI TERAMPIL</option>
                          <option value="Pelaksana">7 - PELAKSANA</option>
										</select>
									</div>
							</div>
              <div class="form-group">
								<label>Hak Akses</label>
									<div class="input-group">
                  <select style="cursor:pointer" tabindex="1" name="flag" class="form-control">
													<option disabled selected="selected" value="0">== PILIHAN ==</option>
              ...
              <div class="form-group">
								...
								<input type="file" required accept="image/jpeg, image/jpg" class="form-control" name="photo">
							</div>
