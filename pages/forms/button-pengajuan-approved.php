          ...
          <div class="modal-content">
            ...
            <button type="button" class="close" data-dismiss="modal">&times;</button>
                ...
                <div class="modal-footer">
                    ...
                    <a href="pengajuan-rejected.php?id=<?php echo $eroww['id']; ?>&&alasan=<?php echo $eroww['alasan']; ?>" class="btn btn-success"> Simpan</a>
                </div>
            </div>
        </div>
    </div>
<!-- /.modal -->
<!-- Approved Pengajuan-->
<div class="modal fade" id="setujuiPengajuan<?php echo $row['id']; ?>">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <button type="button" class="close" data-dismiss="modal">&times;</button>
				...
				<?php
          include "../config_sqli.php";
					$delete=mysqli_query($konek,"SELECT * FROM pengajuan WHERE id='".$row['id']."'");
					$drow=mysqli_fetch_array($delete);
				?>

				<div class="container-fluid">
                Apakah anda yakin <b>"SETUJUI PENGAJUAN"</b> 
				<p></p>NAMA BARANG : <b><?php echo $drow['nama_barang']; ?> ??</b>
				</div> 
				</divss>
                <div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal"> Batal</button>
                    <a href="pengajuan-approved.php?id=<?php echo $drow['id']; ?>" class="btn btn-success"> Simpan</a>
				</div>
